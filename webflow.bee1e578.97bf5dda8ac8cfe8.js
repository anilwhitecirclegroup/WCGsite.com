( () => {
    var e = {
        84345: function(e, t, i) {
            ...
            r.define("slider", e.exports = function(e, t) {
                var i, s, d, l = {}, f = e.tram, u = e(document), c = r.env(), h = ".w-slider", v = "w-slider-force-show", p = a.triggers, m = !1;
                function b() {
                    (i = u.find(h)).length && (i.each(w),
                    d || (g(),
                    r.resize.on(x),
                ...
                function w(t, i) {
                    ...
                    a.nav.off(h),
                    y(a),
                    s ? (a.el.on("setting" + h, C(a)),
                    A(a),
                    a.hasTimer = !1) : (a.el.on("swipe" + h, C(a)),
                    ...
                    c || a.mask.contents().filter(function() {
                ...
                function O(t, i, r) {
                    return function(a) {
                        ...
                        t.hasTimer && A(t)) : (t.ariaLiveLabel.attr("aria-live", "off"),
                        t.hasTimer && W(t))
                    }
                }
                function T(e, t) {
    ...
    var r = i.O(void 0, ["87", "692", "573", "830", "520"], function() {
        return i(51707)
    });
    r = i.O(r)
}
